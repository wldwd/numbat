# Bike Routes to ECU Joondalup Campus

An interactive map showing bike routes, cycle lanes, and amenities for cyclists traveling to Edith Cowan University's Joondalup Campus.
...
- Ensure `joondalup.geojson` file path is correct
